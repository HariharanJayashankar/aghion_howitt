...
oo_.steady_state(6)=oo_.steady_state(3);
if M_.exo_nbr > 0
...
oo_.steady_state( 2 ) = xend(2);
oo_.steady_state( 3 ) = xend(3);
oo_.steady_state( 4 ) = xend(4);
oo_.steady_state( 5 ) = xend(5);
oo_.exo_steady_state( 1 ) = paramsend(7);
oo_.steady_state(6)=oo_.steady_state(3);
steady;
resid;
